...
class ClassificationNet(pl.LightningModule):
    def __init__(self, num_classes):
        ...
        # Load the xception pretrained model as the backbone
        ...
        # Replace the fc layer with a new one with the appropriate number of output classes
        # just change fc layer to adjust for our own classes
    ...
    def training_step(self, batch, batch_idx):
        ...
        return {'loss': loss, 'y': y, 'y_hat': y_hat, 'accuracy': accuracy, 'precision': precision, 'recall': recall,
                'f1 score': f1score}
...
class ClassificationDataset(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        self.train_image_dataset = datasets.ImageFolder(os.path.join(self.data_root_dir, 'train'),
...
data_module = ClassificationDataset(dataset_root_dir='Chicken', train_batch_size=16, val_batch_size=16, test_data=False,
                                    num_workers=2)
